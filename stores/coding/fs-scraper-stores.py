...
MY_API_KEY = 'AIzaSyBCStYlYkMxdXJYJjuVEINvU7U8HBar***' ## THIS IS MY OWN KEY
...
def getGeoloc(add):
    ...
    time.sleep(2)
    param = {'address': add, 'key': 'AIzaSyBCStYlYkMxdXJYJjuVEINvU7U8HBar***'} ## here used Google API
...
#### writing lACit into a file for debugging purposes
f = open("./lACit2", "w")
